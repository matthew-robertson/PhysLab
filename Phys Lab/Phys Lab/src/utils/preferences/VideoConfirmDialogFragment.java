...
public class VideoConfirmDialogFragment extends DialogFragment
{
	private String title = "";
	    ...
	    VideoConfirmDialogListener mListener;
	    ...
	    public void onAttach(Activity activity) {
	        ...
	        try {
	            ...
	            mListener = (VideoConfirmDialogListener) activity;
	        ...
	        builder.setMessage(title)
	               .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
	                   public void onClick(DialogInterface dialog, int id) {
	                       ...
	                       mListener.onDialogPositiveClick(VideoConfirmDialogFragment.this, EnumDialogOptions.DIALOG_DELETE_POINTS_CONFIRM.value);
	                   }
	               })
	               .setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
	                   public void onClick(DialogInterface dialog, int id) {
	                       // Send the negative button event back to the host activity
	                       mListener.onDialogNegativeClick(VideoConfirmDialogFragment.this, EnumDialogOptions.DIALOG_DELETE_POINTS_DENY.value);
	                   }
	               });
