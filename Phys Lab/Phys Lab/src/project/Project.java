		...
		implements Serializable
{
	...
	public ScaleBoundary scaleBoundary;
	...
	public void setScaleBounds(WritableBoundary bounds)
	{
		if(bounds != null)
		{
			scaleBoundary = new ScaleBoundary(bounds);
		}
	}
	...
	public void removePointByValue(RelativeLayout layout, Point point)
	{
		try
		{
			for(int i = 0; i < points.size(); i++)
			{
				if(point.timeStamp == points.get(i).timeStamp)
				{
					layout.removeView(point.imageView);
					points.remove(i);
				}
